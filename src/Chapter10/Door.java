...
//		  creakyDoor.start();		  
  ...
  protected static AudioClip ding = 
		  AudioUtility.getAudioClip(
				  ResourceLoader.class.getResource("/audio/minion_uno.au"));
  protected static AudioClip creakyDoor = 
		  AudioUtility.getAudioClip(
				  ResourceLoader.class.getResource("/audio/open_door.au")); 
}
