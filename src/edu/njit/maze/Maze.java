 ...
 public class Maze implements Cloneable {
     ...
     public void setRoom(Room room) {
         for (int i = 0; i < rooms.size(); i++) {
             ...
             if (room.roomNumber == rm.roomNumber) {
                 // Replace the room
                 rooms.set(i, room);
                 break;
             }
     ...
     public void setCurrentRoom(int roomNumber) {
         System.out.println("finding room number " + roomNumber);
         Room room = findRoom(roomNumber);        
         setCurrentRoom(room);
     }
 
     public void setCurrentRoom(Room room) {
         System.out.println("Entering room number " + room.getRoomNumber());
         if (room != curRoom) {
             if (curRoom != null) {
                 curRoom.setInRoom(false);
             }
             if (room != null) {
                 System.out.println("In Room Number: " + room.getRoomNumber());
                 room.setInRoom(true);
                 curRoom = room;
                 if (room.getKey()){
                     keys++;
 ...
 //                    }
     ...
     public void addToComponent(Panel panel) {
             ...
             switch (code) {
                ...
                case KeyEvent.VK_RIGHT:
                 ...
                 case KeyEvent.VK_ENTER:
                     ...
                     //Open Door command
                     command = new MazeOpenDoorCommand(maze);
                     break;
                 default:
